...
class StatisticByYearFragment :Fragment() {

    lateinit var rcYear : RecyclerView
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.layout_statistics_by_year, container, false)
    }
    ...
    private fun initView(view: View) {
        rcYear = view.findViewById(R.id.rcYear)
        lineChar = view.findViewById(R.id.lineChartYear)
    ...
    private fun DataVal() : ArrayList<Entry>{
        ...
        dataVal.add(Entry(6F,4F))
        dataVal.add(Entry(7F,5F))
        dataVal.add(Entry(8F,3F))
        dataVal.add(Entry(9F, 6F))
        dataVal.add(Entry(10F,7F))
        dataVal.add(Entry(11F,4F))
        dataVal.add(Entry(12F,3F))
        return dataVal
    }
    ...
    override fun onStart() {
        ...
        rcYear.adapter = adapterStatisticWeek
    }
    ...
    private fun setData(){
        ...
        listModelWeekTest.add(ModelWeekTest(5, 5, 5, 5, 10))
        listModelWeekTest.add(ModelWeekTest(6, 5, 5, 5, 10))
        listModelWeekTest.add(ModelWeekTest(7, 5, 5, 5, 10))
        listModelWeekTest.add(ModelWeekTest(8, 5, 5, 5, 10))
        listModelWeekTest.add(ModelWeekTest(9, 5, 5, 5, 10))
        listModelWeekTest.add(ModelWeekTest(10, 5, 5, 5, 10))
        listModelWeekTest.add(ModelWeekTest(11, 5, 5, 5, 10))
        listModelWeekTest.add(ModelWeekTest(12, 5, 5, 5, 10))
    }
}